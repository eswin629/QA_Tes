...
WebUI.setText(findTestObject('Object Repository/Page_Your store. Login/input_Email_Email'), username1)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Your store. Login/input_Password_Password'), password1)
...
WebUI.setText(findTestObject('Object Repository/Page_Your store. Login/input_Email_Email'), username2)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Your store. Login/input_Password_Password'), password2)
